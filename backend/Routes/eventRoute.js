...
import { AddEvent, createBooking, createFeedbackForm, DeleteEvent, EventByID, fetechBookedUsers, getAllEvents, getBycategory, getEventResponseSheet, getFeedbackForm, getUserResponse, submitFeedback, updateEvent } from "../Controllers/eventController.js";
...
PostRouter.get("/admin/response-sheet/:eventName",authUser,getEventResponseSheet);
